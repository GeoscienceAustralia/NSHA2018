...
##################################################################
# The following section is now obsolete as logic tree files now  #
# do not need to be copied across for deaggregation.             #
# Note that the relative paths in the param.txt file for source  #
# and ground motion logic trees are no longer needed, but remain #
# incase anything changes.                                       #
# Job file copy still required for all runs.                     #
# Make sure lt path is included in job file                      #
##################################################################
...
#copy2(src_lt_file, output_dir) # Source logic tree copy no longer needed
#copy2(gsim_lt_file, output_dir) # Ground motion logic tree copy no longer needed
try:
