...
for i, city in enumerate(cities):
    ...
    ini_file = "Templates/job_deag_mag_TEMPLATE.ini"
    txt_file = "Templates/params_deag_mag_hi_mem_TEMPLATE.txt"
    ini_out = "job_deag_mag_" + str(city) + "_" + str(SA_s) + ".ini"
    txt_out = "params_deag_mag_hi_mem_" + str(city) +".txt"
