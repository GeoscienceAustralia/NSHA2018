...
smshp = path.join('shapefiles','SIN_MCC_NSHA18_EDIT.shp' )
...
outshp = path.join('shapefiles','SIN_MCC_NSHA18_UPDATE.shp')
...
for i, poly in enumerate(shapes):
    ...
    # set shape polygon
    w.line(parts=[poly.points], shapeType=shapefile.POLYGON)
