...
idx = where(array(src_codes) == 'KGI')[0]
min_rmag[idx[0]] = 3.4

idx = where(array(src_codes) == 'YUN')[0]
min_rmag[idx[0]] = 3.2

idx = where(array(src_codes) == 'CAN')[0]
min_rmag[idx[0]] = 3.1

idx = where(array(src_codes) == 'NWS')[0]
min_rmag[idx[0]] = 3.5

idx = where(array(src_codes) == 'PPL')[0]
min_rmag[idx[0]] = 3.1

idx = where(array(src_codes) == 'SRT')[0]
min_rmag[idx[0]] = 3.4

idx = where(array(src_codes) == 'HEA')[0]
min_rmag[idx[0]] = 3.1

idx = where(array(src_codes) == 'DAL')[0]
min_rmag[idx[0]] = 3.2
