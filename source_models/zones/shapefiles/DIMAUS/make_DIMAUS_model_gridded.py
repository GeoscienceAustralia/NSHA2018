...
bval_fix = array(bval_fix)
bval_sig_fix = array(bval_sig_fix)
idx = where(bval_fix < 0)[0]
bval_fix[idx] = 1.0
bval_sig_fix[idx] = 0.15
...
idx = where(array(src_codes) == 'OTYB')[0]
min_rmag[idx[0]] = 3.1

idx = where(array(src_codes) == 'BROM')[0]
min_rmag[idx[0]] = 3.3

idx = where(array(src_codes) == 'STRZ')[0]
min_rmag[idx[0]] = 3.1

idx = where(array(src_codes) == 'MSAB')[0]
min_rmag[idx[0]] = 3.2

idx = where(array(src_codes) == 'NEQB')[0]
min_rmag[idx[0]] = 3.5

idx = where(array(src_codes) == 'ULUR')[0]
min_rmag[idx[0]] = 3.3
