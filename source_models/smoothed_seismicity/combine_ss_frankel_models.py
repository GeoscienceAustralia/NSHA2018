...
if __name__ == "__main__":
    output_dir = 'GA_fixed_smoothing_collapsed_mmin3p5'
...
#    filedict = {'Non_cratonic': 'source_model_adelaide_pts.xml'}
    ...
    # Best b values
    filedict_bestb = {'Cratonic': 'smoothed_frankel_50_3_mmin_3.5_b0.779_0.1.xml',
                'Non_cratonic': 'smoothed_frankel_50_3_mmin_3.5_b1.198_0.1.xml',
                'Extended': 'smoothed_frankel_50_3_mmin_3.5_b0.835_0.1.xml'}
    outfile_bestb = 'smoothed_frankel_50_3_mmin_3.5_merged_bestb.xml'
    combine_ss_models(filedict_bestb, domains_shp, lt, outfile_bestb, nrml_version = '04', weight=0.5)#, idbase='ASS')
    # Upper b_values
    filedict_upperb = {'Cratonic': 'smoothed_frankel_50_3_mmin_3.5_b0.708_0.1.xml',
                'Non_cratonic': 'smoothed_frankel_50_3_mmin_3.5_b1.043_0.1.xml',
                'Extended': 'smoothed_frankel_50_3_mmin_3.5_b0.727_0.1.xml'}
    outfile_upperb = 'smoothed_frankel_50_3_mmin_3.5_merged_upperb.xml'
    combine_ss_models(filedict_upperb, domains_shp, lt, outfile_upperb, nrml_version = '04', weight=0.3)
    # Lower b_values                                                                                                     
    filedict_lowerb = {'Cratonic': 'smoothed_frankel_50_3_mmin_3.5_b0.850_0.1.xml',
                       'Non_cratonic': 'smoothed_frankel_50_3_mmin_3.5_b1.352_0.1.xml',
                       'Extended': 'smoothed_frankel_50_3_mmin_3.5_b0.944_0.1.xml'}
    outfile_lowerb = 'smoothed_frankel_50_3_mmin_3.5_merged_lowerb.xml'
    ...
    filename = 'source_model_smoothed_frankel_50_3_mmin_3.5_merged_inc_b_mmax_uncert.xml'
